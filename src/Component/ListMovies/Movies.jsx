...
// here i create a liste of movies and i give all theme a data 
    ...
    const movies = [
        {
            ...
            posterUrl:
                "https://legrandcontinent.eu/fr/wp-content/uploads/sites/2/2019/10/MV5BNGVjNWI4ZGUtNzE0MS00YTJmLWE0ZDctN2ZiYTk2YmI3NTYyXkEyXkFqcGdeQXVyMTkxNjUyNQ@@._V1_.jpg",
            rat: 5,
            gif:
                "https://thumbs.gfycat.com/SafeElectricAfricanwilddog-size_restricted.gif",
        ...
        },
        {
            ...
            rat: 5,
            gif:
                "https://thumbs.gfycat.com/WelldocumentedInsecureChrysomelid-small.gif",
...

        {
            ...
            posterUrl:
                "https://fr.web.img2.acsta.net/pictures/21/03/03/10/28/3138029.jpg",
            rat: 4,
            gif: "https://j.gifs.com/P1VvvA.gif",
            trailerUrl: "https://www.youtube.com/embed/vM-Bja2Gy04",
        },
        {
            id: 4,
            ...
            posterUrl:
                "https://img2.cdn.cinoche.com/images/6358209d0bb3d5da232a64a741d26519.jpg",
            rat: 3,
            gif:
                "https://i.pinimg.com/originals/25/ec/87/25ec8717cbff2591116746fdeeac2a83.gif",
            trailerUrl: "https://www.youtube.com/embed/ab1PnKiMuFs",
        },
    ];
    return movies;
}
