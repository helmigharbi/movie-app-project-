...
// Here you can put all the data related to the movie, as well as put a button to edit and a button to delete 

export default function MovieCard({ movie, onDelete, onEdit, index }) {
  let start = "★";
